...
Pod::Spec.new do |spec|
  ...
  spec.version      = "1.0.0"
  spec.summary      = "A short description of NoPasswordSDK."
  ...
  # Or just: spec.author    = "baoweilin.baowei"
  # spec.authors            = { "baoweilin.baowei" => "baoweilin.baowei@alibaba-inc.com" }
  # spec.social_media_url   = "https://twitter.com/baoweilin.baowei"
